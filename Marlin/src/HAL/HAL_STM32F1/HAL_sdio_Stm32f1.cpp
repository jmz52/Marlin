...
bool SDIO_Init(void) {
  ...
  if (!SDIO_CmdSendCSD((uint32_t)(SdCard.RelCardAdd << 16U))) { return false; }
  ...
  if (!SDIO_CmdSelDesel((uint32_t)(SdCard.RelCardAdd << 16U))) { return false; }
